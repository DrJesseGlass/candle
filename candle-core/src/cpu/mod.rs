...
// simd128 (wasm) is excluded: it has CurrentCpu but not CurrentCpuF16, so f16 vec
// ops fall through to the scalar version below (the f16 KV add isn't a hot path).
