//! Optimized Qwen3 quantized implementation.
//!
//! Key optimizations:
//! - Dequantize weights to F32 once during initialization
//! - All activations stay in F32 throughout computation
//! - No runtime dtype conversions
//! - Cached causal masks
//!
...
// ============================================================================
// OPTIMIZATION: Force F32 for all computations
// ============================================================================
...
// ============================================================================
// OPTIMIZATION: Rotary embeddings always in F32, no conversions
// ============================================================================
#[derive(Debug, Clone)]
...
impl RotaryEmbedding {
    fn new(
        ...
        // OPTIMIZATION: Create directly in F32
...
impl AttentionWeights {
    ...
    fn forward(&mut self, x: &Tensor, attn_mask: Option<&Tensor>, offset: usize) -> Result<Tensor> {
        ...
        // QMatMul dequantizes to F32, so everything stays F32
...
// ============================================================================
// OPTIMIZATION: Cache causal masks, always use F32
// ============================================================================
#[derive(Debug, Clone)]
...
impl ModelWeights {
    pub fn from_gguf<R: Read + Seek>(
        ...
        // OPTIMIZATION: Dequantize embeddings to F32 once
    ...
    pub fn forward(&mut self, input: &Tensor, offset: usize) -> Result<Tensor> {
        ...
        let causal_mask = if l == 1 {
            ...
            Some(self.causal_mask(b, l, offset)?)  // Mutable borrow first
        };
        let _enter = self.span.enter();
